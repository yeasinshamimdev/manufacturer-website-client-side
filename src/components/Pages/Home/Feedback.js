...
const Feedback = () => {
    ...
    return (
        <section>
            <h1 className='text-4xl text-center text-primary mt-10 font-bold'>Feedback</h1>
            <div className='gird md:grid md:grid-cols-2 gap-x-20 gap-y-10 p-4 md:pr-10 mt-4'>
