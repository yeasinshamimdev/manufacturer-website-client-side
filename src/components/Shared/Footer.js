        ...
        <footer>
            <div className="footer p-10 bg-neutral text-neutral-content md:px-10 px-4">
                <div>
                    ...
                    <Link to='/dashboard' className="link link-hover">Branding</Link>
                ...
                <div>
                    ...
                    <Link to='/portfolio' className="link link-hover">About us</Link>
                    <Link to='/portfolio' className="link link-hover">Contact</Link>
                    <Link to='/portfolio' className="link link-hover">Jobs</Link>
            ...
            <div className="footer-center p-4 bg-neutral text-neutral-content">
                <p>Copyright © {year} - All right reserved by Yeasin Shamim</p>
            </div>
        </footer>
    );
};
